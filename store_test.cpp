...
protected:
    void SetUp() override {
        ...
        store_.Put("warble", "Nice weather! I went hiking at Malibu and enjoy my fantastic photos.");
    }
...
TEST_F(StoreTest, getTest) {
    ...
    ASSERT_EQ("Nice weather! I went hiking at Malibu and enjoy my fantastic photos.", store_.Get("warble"));
    ASSERT_EQ("", store_.Get("Hi"));
}
